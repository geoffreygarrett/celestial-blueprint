...
-- vim.opt.listchars = { tab = "» ", trail = "·", nbsp = "␣" }
-- Enhanced listchars configuration
-- vim.opt.listchars = {
-- tab = "→ ", -- Rightward arrow for tabs
--trail = "·", -- Dot for trailing spaces
--nbsp = "␣", -- Symbol for non-breaking spaces
--extends = "▶", -- Symbol for lines extending beyond the window
--precedes = "◀", -- Symbol for lines preceding the window
...
vim.cmd([[
  ...
  " Toggle between file tree and buffer list
  nnoremap <leader>ef :Neotree toggle filesystem<CR>
  nnoremap <leader>eb :Neotree toggle buffers right<CR>

  " Reveal current file in NeoTree
  nnoremap <leader>o :Neotree reveal<CR>
